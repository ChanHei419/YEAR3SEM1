# 1155212799
# Chan Hei Lun
# I use AI to ask this: How to use the finctions in Pytorch and Sklearn to implement questions? Is that right to use this? How can I run faster? 
import numpy as np
import pandas as pd
...
if __name__ == "__main__":
    ...
    print("Image descriptor:", image_descriptor[:3])
    ...
    print("The 10 centres of the images:", centres[:3])
